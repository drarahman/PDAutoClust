...
public class RunMain{
   ...
   //keeps type of attribute information
    ...
    Dataset ds;
    PDAutoClust PDC;
    PDAutoClustAblation pdcAblation;
    ...
    public RunMain(){
        ...
        ds= new Dataset();
        PDC=new PDAutoClust(); 
        pdcAblation=new PDAutoClustAblation();
        mainMenu="\n---------------------PDAutoClust----------------------" +
    ...
    private void pdAutoClust() throws IOException{
        ...
        //Perform PDAutoClustAblation (PDCM1)
        pdcAblation.PDCM1(dataNumerical, recordLabel, attrType, attrName, classValue, classAttributeInfo, dataset); 
        
        //Perform PDAutoClustAblation (PDCM3)
        //pdcAblation.PDCM3(dataNumerical, recordLabel, attrType, attrName, classValue, classAttributeInfo, dataset);  
        
        //Perform PDAutoClustAblation (PDCM4)
        //pdcAblation.PDCM4(dataNumerical, recordLabel, attrType, attrName, classValue, classAttributeInfo, dataset); 
    }
